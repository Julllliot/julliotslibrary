# this function calculates the localZ and localZ_side macros used in julliot:player/looking/target/detect
...
$execute store result storage julliapi:player looking.$(temp).localZ float .01 run scoreboard players get $tmp n
...
$execute store result storage julliapi:player looking.$(temp).localZ_side float .01 run scoreboard players get $tmp n