# ## this checks if the target is within the player's fov
#
# do not ask me how tf this works, I do not fucking know anymore
#
# notes:
...
#
# @context as $(player_selector) facing entity $(target_selector)
