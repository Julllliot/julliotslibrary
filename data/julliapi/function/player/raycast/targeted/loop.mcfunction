...
$execute if score @s julliapi.raycastDistance matches 1.. if block ~ ~ ~ #julliapi:non_solid unless block ~ ~ ~ #julliapi:exceptions $(ray_args)\
positioned ^ ^ ^.25 run return run function julliapi:player/raycast/targeted/loop with storage julliapi:player looking.$(temp)
