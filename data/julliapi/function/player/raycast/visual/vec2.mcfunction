...
$execute if score @s julliapi.raycastDistance matches 0.. positioned ^ ^ ^-.5 run return run function julliapi:player/raycast/visual/vec2 with storage julliapi:player raycast.$(temp)
